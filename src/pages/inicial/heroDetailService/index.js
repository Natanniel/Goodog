...
import { Content, BoxDogProfile, BoxDog, Linha, BoxService, Titulo, CardUser, TituloSection, Profile, ProfileInfo, ProfileNome, ProfileRanking, RankingStars, RankingRecorrencia, FinaisSemana, Valor } from './styled'
