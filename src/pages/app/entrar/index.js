...
function Inicial() {
    ...
    return (
        <div>
            <Content>
                <Link to={'/app/menu'} style={{ display: 'block', position: 'absolute', top: 20, left: 10, height: 50, width: 100, cursor: 'pointer'}}></Link>
                <Link to={'/app/logado'} style={{ display: 'block', position: 'absolute', top: 650, left: 10, height: 50, width: 350, cursor: 'pointer'}}></Link>
